  ...
  const products: Product[] = [
    {
      ...
      description: 'Exquisite golden thread work on pure silk from Varanasi',
      price: 2500,
      originalPrice: 3200,
      rating: 4.8,
      reviews: 124,
    ...
    },
    {
      ...
      description: 'Traditional Jaipur blue pottery with intricate patterns',
      price: 1800,
      rating: 4.6,
      reviews: 89,
    ...
    },
    {
      ...
      description: 'Delicate Odisha silver work with traditional motifs',
      price: 750,
      originalPrice: 950,
      rating: 4.9,
      reviews: 156,
