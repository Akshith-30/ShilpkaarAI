                ...
                <Tabs value={activeTab} onValueChange={setActiveTab}>
                  ...
                  <TabsContent value="orders" className="space-y-4 mt-6">
                    {recentOrders.map((order) => (
                      <div key={order.id} className="flex items-center space-x-4 p-4 bg-secondary/20 rounded-xl">
                        <ImageWithFallback
                          src={order.image}
                          alt="Order item"
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-muted-foreground">
                            {order.items} items • by {order.artisan}
                          </p>
                  ...
                  <TabsContent value="favorites" className="space-y-4 mt-6">
                    {favoriteItems.map((item) => (
                      <div key={item.id} className="flex items-center space-x-4 p-4 bg-secondary/20 rounded-xl">
                        <ImageWithFallback
                          src={item.image}
                          alt={item.name}
                          className="w-16 h-16 object-cover rounded-lg"
